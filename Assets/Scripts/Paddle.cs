...
public class Paddle : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        float newSpeed = Mathf.Clamp(currentSpeed * 1.1f, currentSpeed, currentSpeed * 1.5f); 
        ball.linearVelocity = ballDirection * newSpeed;

        
        ball.AddForce(Vector2.up * 2f, ForceMode2D.Impulse);
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.CompareTag("Bonus"))
        {
            ...
            if (gameManager != null)
            {
                ...
                Debug.Log("Bonus collected! Lives: " + gameManager.lives); 
            }
        }
    }
